...
class CartItemControllerTest {
    ...
    private static Movie movie = MovieFactory.createMovie("MO89","Venom", 90,  "Sci-Fi", 16, "Dragon Studio", "2D", 100, null);
    public static Schedule schedule = ScheduleFactory.createSchedule(LocalTime.of(2, 23), LocalTime.of(2, 23), LocalDate.of(2025, 12, 31), false, movie, theaterRoom);
