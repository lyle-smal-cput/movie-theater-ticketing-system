...
class TicketControllerTest {
    ...
    Card card = CardFactory.createCard("C123", "774", "1234567890123456", LocalDate.of(2025, 12, 31));
    ...
    Movie movie = MovieFactory.createMovie("M123", "Inception", 90, "Something", 16, " The distributor", "2D", 150, null);
